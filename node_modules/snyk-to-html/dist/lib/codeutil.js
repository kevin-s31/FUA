...
exports.processSourceCode = void 0;
...
async function processSourceCode(dataArray) {
    ...
    const OrderedIssuesArray = dataArray.map((project) => {
        return {
            ...
            vulnerabilities: _.orderBy(project.runs[0].results, ['properties.priorityScore'], ['desc']),
        };
    });
    return OrderedIssuesArray;
}
exports.processSourceCode = processSourceCode;
